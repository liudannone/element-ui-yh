...
<script type="text/babel">
  ...
  import { PopupManager } from 'element-ui-yh/src/utils/popup';
  import Locale from 'element-ui-yh/src/mixins/locale';
  import Clickoutside from 'element-ui-yh/src/utils/clickoutside';
  import Dropdown from './dropdown';
  import ElCheckbox from 'element-ui-yh/packages/checkbox';
  import ElCheckboxGroup from 'element-ui-yh/packages/checkbox-group';
