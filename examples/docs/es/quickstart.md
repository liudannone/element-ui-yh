...
```javascript
import Vue from 'vue';
import ElementUI from 'element-ui-yh';
import 'element-ui-yh/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-ui-yh';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'element-ui-yh';
